class Item::Blueprint < ActiveRecord::Base
  belongs_to :blueprint, :class_name => 'Item::Type', :foreign_key => :id
  belongs_to :product, :class_name => 'Item::Type', :foreign_key => :product_type_id 
